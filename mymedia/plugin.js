...
tinymce.PluginManager.add('media', function(editor, url) {
  ...
  function showDialog() {
    ...
    // add video support info
    generalFormItems.push({
      name: 'videosupport',
      type: 'label',
      style: 'border: 0;box-shadow: none;color: #c08319;',
      text: 'Supported video/audio formats: .mov [H.264], .mp4 [H.264 - support iPhone, iPad], .webm, .mp3'
    });
    ...
    if (editor.settings.media_alt_source !== false) {
      generalFormItems.push({name: 'source2', type: 'filepicker', filetype: 'media', size: 40, label: 'Alternative video url'});
    }

    if (editor.settings.media_poster !== false) {
      generalFormItems.push({name: 'poster', type: 'filepicker', filetype: 'image', size: 40, label: 'Preview image url'});
    }
    ...
    generalFormItems.push({
      ...
      type: 'label',
      style: 'border: 0;box-shadow: none;color: #c08319;',
      text: 'If video playback doesn\'t work, please consult wms@roche.com to get more information.'
    });
...

        {
          ...
          items: [
            ...
            embedTextBox,
            {
              ...
              type: 'label',
              style: 'border: 0;box-shadow: none;color: #c08319;',
              text: 'You can paste code from eSource, YouTube, Google calendar or Google map.'
            }
          ]
        }
      ],
  ...
  editor.on('preInit', function() {
    ...
    editor.parser.addNodeFilter('iframe,video,audio,object,embed,script', function(nodes, name) {
      ...
      while (i--) {
        ...
        while (ai--) {
          ...
          if (attrName !== "width" && attrName !== "height" && attrName !== "style" && attrName !== "class") {
        ...
        placeHolder.attr({
          ...
          "class": "mce-object mce-object-" + name + " " + node.attr('class')
        });
    ...
    editor.serializer.addAttributeFilter('data-mce-object', function(nodes, name) {
      ...
      while (i--) {
        ...
        realElm.attr({
          style: node.attr('style'),
          'class': node.attr('class').replace(/mce-object(-video|-iframe|-audio)?/gim, '')
        });
