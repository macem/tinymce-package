...
tinymce.PluginManager.add('mylink', function(editor) {
  ...
  function showDialog(linkList) {
    ...
    var win, onlyText, textListCtrl, linkListCtrl, relListCtrl, targetListCtrl, classListCtrl,
      classListDescCtrl, linkTitleCtrl, value;
    ...
    if (editor.settings.link_class_list) {
      ...
      function buildTextItems() {
          var list = [];
          editor.settings.link_class_list.forEach(function(item) {
  ...
  editor.addMenuItem('mylink', {
    icon: 'link',
    text: 'Insert/edit link [Ctrl+K]',
    shortcut: 'Ctrl+K',
    onclick: createLinkList(showDialog),
    stateSelector: 'a[href]',
    context: 'insert',
