...
tinymce.PluginManager.add('visualblocks', function(editor, url) {
  ...
  editor.addCommand('mceVisualBlocks', mceVisualBlocks);
  editor.addShortcut('Ctrl+G', '', mceVisualBlocks);

  editor.addButton('visualblocks', {
    title: 'Show blocks [Ctrl+G]',
    shortcut: 'Ctrl+G',
    cmd: 'mceVisualBlocks',
