...
tinymce.PluginManager.add('myadvlist', function(editor) {
  ...
  function applyListFormat(listName, styleValue) {
    ...
    list = dom.getParent(sel.getNode(), 'ol,ul');
    if (list && styleValue) {
      dom.setAttrib(list, 'type', styleValue);
  ...
  function updateSelection(e) {
    var listStyleType = editor.dom.getAttrib(editor.dom.getParent(editor.selection.getNode(), 'ol,ul'), 'type') || '';
